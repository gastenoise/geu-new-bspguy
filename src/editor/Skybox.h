...
{
	SKY_FRONT = 0, // ft -> GL_TEXTURE_CUBE_MAP_NEGATIVE_X
	SKY_RIGHT = 1, // rt -> GL_TEXTURE_CUBE_MAP_POSITIVE_Z
	SKY_BACK = 2,  // bk -> GL_TEXTURE_CUBE_MAP_POSITIVE_X
	SKY_LEFT = 3,  // lf -> GL_TEXTURE_CUBE_MAP_NEGATIVE_Z
