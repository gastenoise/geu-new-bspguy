...
{
	SKY_FRONT = 0, // ft -> GL_TEXTURE_CUBE_MAP_POSITIVE_Z
	SKY_BACK = 1,  // bk -> GL_TEXTURE_CUBE_MAP_NEGATIVE_Z
	SKY_UP = 2,    // up -> GL_TEXTURE_CUBE_MAP_POSITIVE_Y
	SKY_DOWN = 3,  // dn -> GL_TEXTURE_CUBE_MAP_NEGATIVE_Y
	SKY_RIGHT = 4, // rt -> GL_TEXTURE_CUBE_MAP_POSITIVE_X
	SKY_LEFT = 5,  // lf -> GL_TEXTURE_CUBE_MAP_NEGATIVE_X
	SKY_NUM_FACES = 6
};
