...
void Settings::loadDefaultSettings()
{
	...
	render_flags = g_render_flags =
		(RENDER_TEXTURES | RENDER_LIGHTMAPS | RENDER_SPECIAL | RENDER_ENTS | RENDER_SPECIAL_ENTS | RENDER_POINT_ENTS |
		 RENDER_WIREFRAME | RENDER_ENT_CONNECTIONS | RENDER_ENT_CLIPNODES | RENDER_MODELS | RENDER_MODELS_ANIMATED |
		 RENDER_WORLD_CLIPNODES | RENDER_ORIGIN);
	...
	unsigned char default_data[0x300] = {
		,
		...
		if (!entry.is_directory())
		{
			...
			if (ends_with(filename, ".pal"))
			{
				...
				if (readFile(entry.path().string(), palData))
				{
					...
					{
						print_log(PRINT_RED, "Bad palette \"{}\" size : {} bytes!", entry.path().string(),
								  palData.size());
					}
					else
					{
						...
						filename.pop_back();
						palettes.push_back(
							{toUpperCase(filename), (unsigned int)(palData.size() / sizeof(COLOR3)), NULL});
...
{
	if (fileExists(file) &&
		std::find(g_settings.lastOpened.begin(), g_settings.lastOpened.end(), file) == g_settings.lastOpened.end())
	{
...
void Settings::loadSettings()
{
	...
	g_settings.texbrowser_open =
		settings_ini->Get<int>("WIDGETS", "texbrowser_open", 0) != 0 && g_settings.save_windows;
	...
	if (limitEngines > 0)
	{
		...
		for (int i = 0; i < limitEngines; i++)
		{
			std::string engineName =
				settings_ini->Get<std::string>("ENGINE", "name" + std::to_string(i + 1), "half-life1");
			...
			limitsMap[engineName].maxMapVisdata =
				settings_ini->Get<int>(engineName, "MAX_MAP_VISDATA", 64) * 1024 * 1024;
			...
			limitsMap[engineName].maxMapLightdata =
				settings_ini->Get<int>(engineName, "MAX_MAP_LIGHTDATA", 64) * 1024 * 1024;
			limitsMap[engineName].maxTextureDimension =
				settings_ini->Get<int>(engineName, "MAX_TEXTURE_DIMENSION", 4096);
			limitsMap[engineName].maxTextureSize =
				((g_limits.maxTextureDimension * g_limits.maxTextureDimension * 2 * 3) / 2);
	...
	if (g_settings.windowY == -32000 && g_settings.windowX == -32000)
	{
...
void Settings::saveSettings(std::string path)
{
	...
	iniData << "map_boundary_color=" << (int)g_settings.mapBoundaryColor.r << " " << (int)g_settings.mapBoundaryColor.g
			<< " " << (int)g_settings.mapBoundaryColor.b << "\n";
	...
	{
		iniData << (i + 1) << "=" << (g_settings.fgdPaths[i].enabled ? "enabled" : "disabled") << "?"
	...
	{
		iniData << (i + 1) << "=" << (g_settings.resPaths[i].enabled ? "enabled" : "disabled") << "?"
				<< g_settings.resPaths[i].path << "\n";
	}
	iniData << "\n";
...
{
	if (key == "window_width" || key == "window_height" || key == "window_x" || key == "window_y" ||
		key == "window_maximized" || key == "save_windows" || key == "debug_open" || key == "keyvalue_open" ||
		key == "transform_open" || key == "log_open" || key == "limits_open" || key == "entreport_open" ||
		key == "texbrowser_open" || key == "goto_open" || key == "settings_tab" || key == "start_at_entity" ||
		key == "savebackup" || key == "save_crc" || key == "save_cam" || key == "auto_import_ent" ||
		key == "same_dir_for_ent" || key == "reload_ents_list" || key == "strip_wad_path" ||
		key == "default_is_empty" || key == "undo_levels" || key == "language")
	{
		if (key == "language")
			key = "lang";
		return "GENERAL";
	}
	if (key == "vsync" || key == "fov" || key == "zfar" || key == "renders_flags" || key == "font_size" ||
		key == "fpslimit" || key == "mark_unused_texinfos" || key == "merge_verts" || key == "merge_edges")
	{
		return "GRAPHICS";
	}
	...
	if (key == "gamedir" || key == "workingdir" || key == "lastdir" || key == "hlrad_path" || key == "palette")
	{
		return "PATHS";
	}
	if (key == "fgd" || key == "res")
	...
	if (key == "optimizer_cond_ents" || key == "optimizer_no_hulls_ents" || key == "optimizer_no_collision_ents" ||
		key == "optimizer_passable_ents" || key == "optimizer_player_hull_ents" ||
		key == "optimizer_monster_hull_ents" || key == "negative_pitch_ents" || key == "transparent_textures" ||
		key == "transparent_entities")
	{
		return toUpperCase(key);
	}
	if (key == "verbose_logs")
