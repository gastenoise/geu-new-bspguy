...
template <class... Args> void print_log(unsigned int colors, const std::string &format, Args... args)
{
...
template <class... Args> void print_log(const std::string &format, Args... args)
{
	std::string line = fmt::vformat(format, fmt::make_format_args(args...));
